...
number_of_stores.times do |s|
    ...
    positionArray.each do |position|
        number_of_employees.times do |n| #Employees
            ...
            if(n%2 == 0) then
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: false, date: Date.new(2016, 11, 14), startTime: "6:00am", endTime: "4:00pm")
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: false, date: Date.new(2016, 11, 15), startTime: "4:00pm", endTime: "11:00pm")
                Schedule.create(user_id: user.id, position_id: user.position.first, available: false, date: Date.new(2016, 11, 16), startTime: "6:00am", endTime: "4:00pm")
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: false, date: Date.new(2016, 11, 17), startTime: "4:00pm", endTime: "11:00pm")
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: false, date: Date.new(2016, 11, 18), startTime: "6:00am", endTime: "4:00pm")
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: false, date: Date.new(2016, 11, 19), startTime: "4:00pm", endTime: "11:00pm")
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: false, date: Date.new(2016, 11, 20), startTime: "6:00am", endTime: "4:00pm")
            else 
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: true, date: Date.new(2016, 11, 14), startTime: "4:00pm", endTime: "11:00pm")
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: true, date: Date.new(2016, 11, 15), startTime: "6:00am", endTime: "4:00pm")
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: true, date: Date.new(2016, 11, 16), startTime: "4:00pm", endTime: "11:00pm")
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: true, date: Date.new(2016, 11, 17), startTime: "6:00am", endTime: "4:00pm")
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: true, date: Date.new(2016, 11, 18), startTime: "4:00pm", endTime: "11:00pm")
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: true, date: Date.new(2016, 11, 19), startTime: "6:00am", endTime: "4:00pm")
                Schedule.create(user_id: user.id, position_id: user.position.first.id, available: true, date: Date.new(2016, 11, 20), startTime: "4:00pm", endTime: "11:00pm")
            end
        end
        count = count+1
    end
